...
## Current State — Phase 8 ĐÃ HOÀN THÀNH & MERGE (04/06/2026)
- Phase 8 đã merge vào `main`: 7/7 TIPs PASS — KH mới, KHHH, gộp Charts+Revenue vào trang mới.
- **Pending**: Sếp nghiệm thu thực tế tại `http://127.0.0.1:8050`. cho Module BCCP trên nhánh `feat/bccp-upgrade` tại worktree `E:\Projects\worktrees\Dashboard-BCCP\feat-bccp-upgrade`.
...
12. **[PENDING] Phase 5C**: Deploy server nội bộ + chuyển PostgreSQL

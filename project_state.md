...
## Current State — Phase 8 ĐANG TRIỂN KHAI (Nâng cấp Module BCCP)
- Đang thực hiện nhánh `feat/bccp-upgrade` tại worktree `E:\Projects\worktrees\Dashboard-BCCP\feat-bccp-upgrade`.
- Đã hoàn thành 2/7 TIPs cho Module BCCP (Phần dữ liệu KH bán mới lịch sử và Trigger tự động tính toán sau khi import).
...
10. **[IN PROGRESS 🔄] Phase 8 — Nâng cấp Module BCCP (retention, new customer, gộp UI)**:
    - **Trạng thái**: Đang thực hiện trên branch `feat/bccp-upgrade`. Đã xong 2/7 TIPs.
    ...
    - [ ] TIP-bccp-003 (P1): Gộp Charts vào trang `/bccp`

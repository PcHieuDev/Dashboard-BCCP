...
def create_customer_detail_layout():
    ...
    return html.Div([
        # ==============================================================================
        # PHẦN A - BỘ LỌC DỊCH VỤ BCCP INLINE
        # ==============================================================================
        html.Div("⚙️ Bộ lọc dịch vụ BCCP (Inline)", className="section-header"),
        dbc.Row([
            # 1. Nhóm dịch vụ
            dbc.Col([
        ...
        # ==============================================================================
        # PHẦN B - BẢNG DOANH THU XOAY CHIỀU (TỪ REVENUE_DETAIL)
        # ==============================================================================
        html.Div("🎛️ Báo cáo Doanh thu xoay chiều", className="section-header"),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Button("📥 Xuất Excel Doanh thu", id="revenue-btn-export-excel", color="success", className="me-2", size="sm"),
